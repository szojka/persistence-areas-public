...
source(here::here("Persistence thresholds/Supp Bayesian models/Scripts - generate stan figures/95CI/Stats -  natural misalignments (multinomial).R"))
source(here::here("Persistence thresholds/Supp Bayesian models/Scripts - generate stan figures/95CI/Stats - persistence & occurrence by treatment across discrete scales.R"))
...
#-----------------------------------------------------------------------------.
# graph
jpeg('Persistence thresholds/Figures/Bayes/95CI/fig_1.jpeg', width = 8.5, height = 4.5, units = 'in', res = 300)
...
pagedown::chrome_print(input = gt_file,
                       output = here::here("Persistence thresholds/Tables/Bayes/95CI/1_STAN_tab_multinomial_estimates.pdf"))

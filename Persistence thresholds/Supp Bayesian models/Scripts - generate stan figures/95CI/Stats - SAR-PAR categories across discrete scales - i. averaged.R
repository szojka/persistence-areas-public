...
#-------------------------------------------------------------------------------
# DESCRIPTION: Figure 4B  Bayes version
#-------------------------------------------------------------------------------
...
# load model
load(here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.p_avg_brm.rdata"))
...
em <- emmeans(m.p_avg_brm, ~type, type = "response") # specify green_index_scaled values
...
# load model
load(here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.g_avg_brm.rdata"))
...
# load model
#load(paste0(here::here(), "/Scripts - stan persistence/95CI/m.s_avg_brm.rdata"))
load(here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.s_avg_brm.rdata"))
...
tab_avg_PAR_estimates <- vis2 |>
 ...
 pagedown::chrome_print(input = gt_file,
                        output = here::here("Tables/Bayes/95CI/12_STAN_tab_avg_PAR_estimates.pdf"))

...
#------------------------------------------------------------------------------
# DESCRIPTION: Run stan model for Bayes version of Figure 2 (potential biases corrected)
#------------------------------------------------------------------------------
...
# save model
 save(m.plot_brm, file = here::here("Persistence thresholds/Supp Bayesian models/Stan rdata/brms 95CI/m.plot_brm.rdata"))
...
# model:
 ...
 # save model
 save(m.grid_brm, file = here::here("Persistence thresholds/Supp Bayesian models/Stan rdata/brms 95CI/m.grid_brm.rdata"))
...
# save model
save(m.site_brm, file = here::here("Persistence thresholds/Supp Bayesian models/Stan rdata/brms 95CI/m.site_brm.rdata"))

...
Fit <- stan(file = paste0(getwd(),'/Supp Bayesian models/Stan models/multinomial.stan'), data = c("y_mat", "N", "J", "S", "Site", "G","Grid"), iter = 2000, chains = 4, thin = 2, init = initials1)

nat_mis_fit <- Fit 

save(nat_mis_fit, file = here::here("Persistence thresholds/Supp Bayesian models/Stan rdata/brms 95CI/nat_mis_fit.rdata"))

...
# save model
save(m.p_avg_brm, file = here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.p_avg_brm.rdata"))
...
#save model
save(m.g_avg_brm, file = here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.g_avg_brm.rdata"))
...
min(dat$species_prop); max(dat$species_prop)
 ...
 # save model 
 save(m.s_avg_brm, file = here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.s_avg_brm.rdata"))

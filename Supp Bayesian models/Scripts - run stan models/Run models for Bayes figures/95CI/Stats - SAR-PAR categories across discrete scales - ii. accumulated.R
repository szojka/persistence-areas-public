...
# save model
save(m.p_brm, file = here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.p_brm.rdata"))
...
#save model
save(m.g_brm, file = here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.g_brm.rdata"))
...
# save model
save(m.s_brm, file = here::here("Supp Bayesian models/Stan rdata/brms 95CI/m.s_brm.rdata"))

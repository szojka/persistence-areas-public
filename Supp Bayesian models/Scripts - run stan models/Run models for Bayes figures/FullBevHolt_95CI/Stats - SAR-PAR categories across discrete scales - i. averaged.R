...
#-------------------------------------------------------------------------------
# DESCRIPTION: Run stan model for Bayes version of Figure 4F (full Beverton-Holt)
#-------------------------------------------------------------------------------
...
# save model
save(m.p_avg_brm, file = here::here("Supp Bayesian models/Stan rdata/FullBevHolt/95CI/m.p_avg_brm.rdata"))
...
# save model
save(m.g_avg_brm, file = here::here("Supp Bayesian models/Stan rdata/FullBevHolt/95CI/m.g_avg_brm.rdata"))
...
# save model
save(m.s_avg_brm, file = here::here("Supp Bayesian models/Stan rdata/FullBevHolt/95CI/m.s_avg_brm.rdata"))

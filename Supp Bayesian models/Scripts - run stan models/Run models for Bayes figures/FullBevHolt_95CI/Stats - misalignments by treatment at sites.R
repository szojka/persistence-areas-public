#-----------------------------------------------------------------------------.
# DESCRIPTION: Run stan model for Bayes version of Figure 3 at site level (full Beverton-Holt)
#-----------------------------------------------------------------------------.
...
# save model
save(m.s.pts_brm, file = here::here("Supp Bayesian models/Stan rdata/FullBevHolt/95CI/m.s.pts_brm.rdata"))

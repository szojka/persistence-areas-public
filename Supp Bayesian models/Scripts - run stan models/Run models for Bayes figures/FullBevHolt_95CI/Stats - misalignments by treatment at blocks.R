...
#-----------------------------------------------------------------------------.
# DESCRIPTION: Run stan model for Bayes version of Figure 3 at block level (full Beverton-Holt)
#-----------------------------------------------------------------------------.
...
# save model
save(m.b.pts_brm, file = here::here("Supp Bayesian models/Stan rdata/FullBevHolt/95CI/m.b.pts_brm.rdata"))

...
#------------------------------------------------------------
## DESCRIPTION: Source code for running stan models 
# with full Beverton-holt predictions
#------------------------------------------------------------
...
load(here::here("Supp Bayesian models/Stan rdata/fullBH_pred_data_saved_95CI.rdata"))
...
load(here::here("Supp Bayesian models/Stan rdata/fullBH_grid_pred_95CI.rdata"))
...
# join with the grid_pred data that has persistence:
load(here::here("Supp Bayesian models/Stan rdata/fullBH_site_pred_95CI.rdata"))

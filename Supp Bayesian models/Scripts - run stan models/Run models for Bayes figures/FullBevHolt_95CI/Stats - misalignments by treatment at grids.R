...
#-----------------------------------------------------------------------------.
# DESCRIPTION: Run stan model for Bayes version of Figure 3 at grid level (full Beverton-Holt)
#-----------------------------------------------------------------------------.
...
# save model
save(m.g.pts_brm, file = here::here("Supp Bayesian models/Stan rdata/FullBevHolt/95CI/m.g.pts_brm.rdata"))

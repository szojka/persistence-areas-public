...
# Predictions from full Beverton-Holt model, using 95% credible intervals 
...
brohor_dat$lambda_ei_lower <- apply(post$lambda_ei_out, 2, quantile, probs = 0.025)
brohor_dat$lambda_ei_upper <- apply(post$lambda_ei_out, 2, quantile, probs = 0.975)

# intra predictions 
brohor_dat$alpha_intra_ei <- apply(post$alpha_intra_ei_out, 2, median)
brohor_dat$alpha_intra_ei_lower <- apply(post$alpha_intra_ei_out, 2, quantile, probs = 0.025)
brohor_dat$alpha_intra_ei_upper <- apply(post$alpha_intra_ei_out, 2, quantile, probs = 0.975)

# inter predictions
brohor_dat$alpha_other_ei <- apply(post$alpha_other_ei_out, 2, median)
brohor_dat$alpha_other_ei_lower <- apply(post$alpha_other_ei_out, 2, quantile, probs = 0.025)
brohor_dat$alpha_other_ei_upper <- apply(post$alpha_other_ei_out, 2, quantile, probs = 0.975)
...
brohor_dat$y_hat_lower <- apply(post$y_hat, 2, quantile, probs = 0.025)
brohor_dat$y_hat_upper <- apply(post$y_hat, 2, quantile, probs = 0.975)
...
brohor_dat$y_hat_no_intra_lower <- apply(post$y_hat_no_intra, 2, quantile, probs = 0.025)
brohor_dat$y_hat_no_intra_upper <- apply(post$y_hat_no_intra, 2, quantile, probs = 0.975)
...
brohor_dat$y_hat_baseline_lower <- apply(post$y_hat_baseline, 2, quantile, probs = 0.025)
brohor_dat$y_hat_baseline_upper <- apply(post$y_hat_baseline, 2, quantile, probs = 0.975)
...
vulmic_dat$lambda_ei_lower <- apply(post$lambda_ei_out, 2, quantile, probs = 0.025)
vulmic_dat$lambda_ei_upper <- apply(post$lambda_ei_out, 2, quantile, probs = 0.975)

# intra predictions 
vulmic_dat$alpha_intra_ei <- apply(post$alpha_intra_ei_out, 2, median)
vulmic_dat$alpha_intra_ei_lower <- apply(post$alpha_intra_ei_out, 2, quantile, probs = 0.025)
vulmic_dat$alpha_intra_ei_upper <- apply(post$alpha_intra_ei_out, 2, quantile, probs = 0.975)

# inter predictions
vulmic_dat$alpha_other_ei <- apply(post$alpha_other_ei_out, 2, median)
vulmic_dat$alpha_other_ei_lower <- apply(post$alpha_other_ei_out, 2, quantile, probs = 0.025)
vulmic_dat$alpha_other_ei_upper <- apply(post$alpha_other_ei_out, 2, quantile, probs = 0.975)

# fecundity predictions (all accounting for site-level epsilons):

# predictions calculated with all parameters in BH
vulmic_dat$y_hat <- apply(post$y_hat, 2, median)
vulmic_dat$y_hat_lower <- apply(post$y_hat, 2, quantile, probs = 0.025)
vulmic_dat$y_hat_upper <- apply(post$y_hat, 2, quantile, probs = 0.975)

# predictions calculated where intraspecific density accounted for
vulmic_dat$y_hat_no_intra <- apply(post$y_hat_no_intra, 2, median)
vulmic_dat$y_hat_no_intra_lower <- apply(post$y_hat_no_intra, 2, quantile, probs = 0.025)
vulmic_dat$y_hat_no_intra_upper <- apply(post$y_hat_no_intra, 2, quantile, probs = 0.975)

# predictions calculated where so that no interactions; low density growth rate
vulmic_dat$y_hat_baseline <- apply(post$y_hat_baseline, 2, median)
vulmic_dat$y_hat_baseline_lower <- apply(post$y_hat_baseline, 2, quantile, probs = 0.025)
vulmic_dat$y_hat_baseline_upper <- apply(post$y_hat_baseline, 2, quantile, probs = 0.975)
...
plaere_dat$lambda_ei_lower <- apply(post$lambda_ei_out, 2, quantile, probs = 0.025)
plaere_dat$lambda_ei_upper <- apply(post$lambda_ei_out, 2, quantile, probs = 0.975)

# intra predictions 
plaere_dat$alpha_intra_ei <- apply(post$alpha_intra_ei_out, 2, median)
plaere_dat$alpha_intra_ei_lower <- apply(post$alpha_intra_ei_out, 2, quantile, probs = 0.025)
plaere_dat$alpha_intra_ei_upper <- apply(post$alpha_intra_ei_out, 2, quantile, probs = 0.975)

# inter predictions
plaere_dat$alpha_other_ei <- apply(post$alpha_other_ei_out, 2, median)
plaere_dat$alpha_other_ei_lower <- apply(post$alpha_other_ei_out, 2, quantile, probs = 0.025)
plaere_dat$alpha_other_ei_upper <- apply(post$alpha_other_ei_out, 2, quantile, probs = 0.975)

# fecundity predictions (all accounting for site-level epsilons):

# predictions calculated with all parameters in BH
plaere_dat$y_hat <- apply(post$y_hat, 2, median)
plaere_dat$y_hat_lower <- apply(post$y_hat, 2, quantile, probs = 0.025)
plaere_dat$y_hat_upper <- apply(post$y_hat, 2, quantile, probs = 0.975)

# predictions calculated where intraspecific density accounted for
plaere_dat$y_hat_no_intra <- apply(post$y_hat_no_intra, 2, median)
plaere_dat$y_hat_no_intra_lower <- apply(post$y_hat_no_intra, 2, quantile, probs = 0.025)
plaere_dat$y_hat_no_intra_upper <- apply(post$y_hat_no_intra, 2, quantile, probs = 0.975)

# predictions calculated where so that no interactions; low density growth rate
plaere_dat$y_hat_baseline <- apply(post$y_hat_baseline, 2, median)
plaere_dat$y_hat_baseline_lower <- apply(post$y_hat_baseline, 2, quantile, probs = 0.025)
plaere_dat$y_hat_baseline_upper <- apply(post$y_hat_baseline, 2, quantile, probs = 0.975)
...
miccal_dat$lambda_ei_lower <- apply(post$lambda_ei_out, 2, quantile, probs = 0.025)
miccal_dat$lambda_ei_upper <- apply(post$lambda_ei_out, 2, quantile, probs = 0.975)

# intra predictions 
miccal_dat$alpha_intra_ei <- apply(post$alpha_intra_ei_out, 2, median)
miccal_dat$alpha_intra_ei_lower <- apply(post$alpha_intra_ei_out, 2, quantile, probs = 0.025)
miccal_dat$alpha_intra_ei_upper <- apply(post$alpha_intra_ei_out, 2, quantile, probs = 0.975)

# inter predictions
miccal_dat$alpha_other_ei <- apply(post$alpha_other_ei_out, 2, median)
miccal_dat$alpha_other_ei_lower <- apply(post$alpha_other_ei_out, 2, quantile, probs = 0.025)
miccal_dat$alpha_other_ei_upper <- apply(post$alpha_other_ei_out, 2, quantile, probs = 0.975)

# fecundity predictions (all accounting for site-level epsilons):

# predictions calculated with all parameters in BH
miccal_dat$y_hat <- apply(post$y_hat, 2, median)
miccal_dat$y_hat_lower <- apply(post$y_hat, 2, quantile, probs = 0.025)
miccal_dat$y_hat_upper <- apply(post$y_hat, 2, quantile, probs = 0.975)

# predictions calculated where intraspecific density accounted for
miccal_dat$y_hat_no_intra <- apply(post$y_hat_no_intra, 2, median)
miccal_dat$y_hat_no_intra_lower <- apply(post$y_hat_no_intra, 2, quantile, probs = 0.025)
miccal_dat$y_hat_no_intra_upper <- apply(post$y_hat_no_intra, 2, quantile, probs = 0.975)

# predictions calculated where so that no interactions; low density growth rate
miccal_dat$y_hat_baseline <- apply(post$y_hat_baseline, 2, median)
miccal_dat$y_hat_baseline_lower <- apply(post$y_hat_baseline, 2, quantile, probs = 0.025)
miccal_dat$y_hat_baseline_upper <- apply(post$y_hat_baseline, 2, quantile, probs = 0.975)
...
pred_data$persist_final <- pred_data$persist_3_cred # regardless of treatment, using lower credible interval from full Beverton-Holt model
...
pred_data$predicted_fecundity <- pred_data$y_hat
pred_data$predicted_fecundity_lwr <-  pred_data$y_hat_lower
pred_data$predicted_fecundity_upr <-  pred_data$y_hat_upper
...
for(i in 1:length(column_names)) { # this indexes column number
  ...
  grid_sum_dat <- rbind(grid_sum_dat, temp)
  print((i/20000)*100)
...
dat_ab <- grid_sum_dat %>%
  ...
  mutate(y_hat = median(site_sum)) %>%
  mutate(y_hat_lower = quantile(site_sum, probs = 0.025)) %>%
  mutate(y_hat_upper = quantile(site_sum, probs = 0.975)) %>%
  ungroup() %>%
  select(site, biotic_treatment, y_hat, y_hat_lower, y_hat_upper) %>%
  distinct()

# add grid-level predicted fecundity

dat_ab$grid_predicted_fecundity <- NA
dat_ab$grid_predicted_fecundity_lwr <- NA
dat_ab$grid_predicted_fecundity_upr <- NA

dat_ab$grid_predicted_fecundity <- dat_ab$y_hat
dat_ab$grid_predicted_fecundity_lwr <- dat_ab$y_hat_lower
dat_ab$grid_predicted_fecundity_upr <- dat_ab$y_hat_upper
...
for(i in 1:length(column_names)) { # this indexes column number
  ...
  site_sum_dat <- rbind(site_sum_dat, temp)
  print((i/20000)*100)
...
dat_ab$site_predicted_fecundity <- dat_ab$y_hat
dat_ab$site_predicted_fecundity_lwr <- dat_ab$y_hat_lower
dat_ab$site_predicted_fecundity_upr <- dat_ab$y_hat_upper
...
# pred_dat_saved
# write csv
save(pred_data_saved, file = here::here("Supp Bayesian models/Stan rdata/fullBH_pred_data_saved_95CI.rdata"))# cluster

# grid_pred
save(grid_pred, file = here::here("Supp Bayesian models/Stan rdata/fullBH_grid_pred_95CI.rdata"))# cluster

# site_pred
save(site_pred, file = here::here("Supp Bayesian models/Stan rdata/fullBH_site_pred_95CI.rdata"))# cluster

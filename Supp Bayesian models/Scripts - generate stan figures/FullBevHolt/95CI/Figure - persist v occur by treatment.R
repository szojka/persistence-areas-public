...
# source(here::here("Supp bayesian models/Scripts - generate stan figures/FullBevHolt/95CI/Source - MAIN fitnessdata POST STAN.R")) # loaded in following script:
...
pagedown::chrome_print(input = gt_file,
                       output = here::here("Tables/y_hat/FullBevHolt/95CI/3_STAN_tab_occ.v.per_estimates.pdf"))
...
#---------------------------------------------------------------------------
jpeg('Figures/Bayes/FullBevHolt/95CI/fig_occ_persist_by_treatment.jpeg', width = 10, height = 5, units = 'in', res = 600)
figa
dev.off()
#---------------------------------------------------------------------------

...
source(here::here("Supp bayesian models/Scripts - generate stan figures/FullBevHolt/95CI/Stats - misalignments by treatment at blocks.R"))
source(here::here("Supp bayesian models/Scripts - generate stan figures/FullBevHolt/95CI/Stats - misalignments by treatment at grids.R"))
source(here::here("Supp bayesian models/Scripts - generate stan figures/FullBevHolt/95CI/Stats - misalignments by treatment at sites.R")) # warnings here are ok
...
jpeg('Figures/Bayes/FullBevHolt/95CI/fig_2_scaleonx.jpeg', width = 8.5, height = 7, units = 'in', res = 600)
fig2_points
dev.off()
...
pagedown::chrome_print(input = gt_file,
                       output = here::here("Tables/Bayes/FullBevHolt/95CI/6_STAN_tab_neighbor_estimates.pdf"))

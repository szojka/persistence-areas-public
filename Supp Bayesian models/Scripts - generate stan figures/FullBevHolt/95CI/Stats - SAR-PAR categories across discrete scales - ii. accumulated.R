...
#-------------------------------------------------------------------------------
# DESCRIPTION: Figure 4E stats, Bayes version (predictions from full Beverton-Holt)
#-------------------------------------------------------------------------------
...
source(here::here("Supp Bayesian models/Scripts - generate stan figures/FullBevHolt/95CI/Source - MAIN fitnessdata POST STAN.R")) # must run to reset data I used in 'averaged' script.
...
# Summing persistence grouped by grid, and if > 0, persistence = 1
...
# load model
load(here::here("Supp Bayesian models/Stan rdata/brms FullBevHolt/95CI/m.p_brm.rdata"))
...
# load model
load(here::here("Supp Bayesian models/Stan rdata/brms FullBevHolt/95CI/m.g_brm.rdata"))
...
# load model
load(here::here("Supp Bayesian models/Stan rdata/brms FullBevHolt/95CI/m.s_brm.rdata"))
...
pagedown::chrome_print(input = gt_file,
                      output = here::here("Tables/Bayes/FullBevHolt/95CI/9_STAN_tab_acc_PAR_estimates.pdf"))

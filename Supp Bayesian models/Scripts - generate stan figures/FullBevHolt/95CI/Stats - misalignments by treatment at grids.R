...
#-----------------------------------------------------------------------------.
# DESCRIPTION: Figure 3 grids stats, Bayes version (predictions from full Beverton-Holt)
#-----------------------------------------------------------------------------.
...
# load model
load(here::here("Supp Bayesian models/Stan rdata/brms FullBevHolt/95CI/m.g.pts_brm.rdata"))

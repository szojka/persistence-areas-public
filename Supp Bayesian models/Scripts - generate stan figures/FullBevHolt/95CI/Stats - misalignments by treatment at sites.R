#-----------------------------------------------------------------------------.
# DESCRIPTION: Figure 3 site stats, Bayes version (predictions from full Beverton-Holt)
#-----------------------------------------------------------------------------.
...
load(here::here("Supp Bayesian models/Stan rdata/brms FullBevHolt/95CI/m.s.pts_brm.rdata"))

...
source(here::here("Supp bayesian models/Scripts - generate stan figures/FullBevHolt/95CI/Stats - SAR-PAR categories across discrete scales - i. averaged.R")) # loads main source too

# ii. ACCUMULATED METHOD OF PERSISTENCE
source(here::here("Supp bayesian models/Scripts - generate stan figures/FullBevHolt/95CI/Stats - SAR-PAR categories across discrete scales - ii. accumulated.R")) # loads main source too
...
#---------------------------------------------------------------------------
library(patchwork)
png("Figures/Bayes/FullBevHolt/95CI/discrete_SAR-PAR_full.png", height = 10, width = 7, units = "in", res=800)
par_dat
dev.off()
#---------------------------------------------------------------------------
